...
- **61 styled, copy-in registry components** — framed controls, prose, and
...
- **A real CLI.** `primitiv add button` drops a styled component — one of
  **61** in the registry, from framed controls up through full composites
...
On top of the headless library, the **registry** ships 61 styled, copy-in
