...
- [x] Combobox — headless built (single-select, consumer-owned filtering, virtual-focus cursor shared with Listbox). Design settled on the Figma "Combobox — exploration" page; deferred items (built-in `filter`, async loading, multi-select, virtualization) recorded there. Registry surface + kitchen-sink demo still to come
- [x] Listbox
