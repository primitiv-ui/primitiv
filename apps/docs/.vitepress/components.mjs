...
export const reactComponents = [
  ...
  { name: "SplitButton", group: "Buttons" },
  ...
  { name: "SegmentedControl", group: "Forms" },
  { name: "Select", group: "Forms" },
  { name: "Slider", group: "Forms" },
  { name: "Switch", group: "Forms" },
  { name: "Textarea", group: "Forms" },
  { name: "Combobox", group: "Collections & Selection" },
  { name: "Listbox", group: "Collections & Selection" },
  ...
  { name: "NavigationMenu", group: "Navigation" },
