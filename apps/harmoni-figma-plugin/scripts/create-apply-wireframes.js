 ...
 *
 *   Screen 3 — Apply: initial state
 *              Palette editor with Apply section visible; no outputs selected,
 *              no collection chosen, Apply button disabled.
 *
 *   Screen 4 — Apply: Colour variables selected + collection picker open
 *              Palette editor with "Colour variables" checked and the
 *              collection dropdown open (opens upward to stay in frame).
 *
...
(async function createApplyWireframes() {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // SCREEN 3 — Apply: initial state (nothing selected, button disabled)
  // ═══════════════════════════════════════════════════════════════════════════
  const s3=mkPaletteEditor(
    "Screen 3 — Apply (initial)", PITCH*2, "Acme Corp", "Neutral",
    {},
    { applyStylesChecked:false, applyVarsChecked:false, applyCollection:null, applyEnabled:false }
  );

  // ═══════════════════════════════════════════════════════════════════════════
  // SCREEN 4 — Apply: Colour variables checked, collection picker open
  // ═══════════════════════════════════════════════════════════════════════════
  const s4=mkPaletteEditor(
    "Screen 4 — Apply (collection open)", PITCH*3, "Acme Corp", "Neutral",
    {},
    { applyVarsChecked:true, applyCollection:"My Library", collectionOpen:true }
  );

  figma.viewport.scrollAndZoomIntoView([s3,s4]);
  console.log('✓ Added Screens 3 & 4 (Apply states) to "Wireframes — Harmoni Plugin".');
