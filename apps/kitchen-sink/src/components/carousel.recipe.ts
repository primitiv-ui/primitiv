...
export const carousel = cva("primitiv-carousel", {
  variants: {
    ...
    radius: {
      none: "primitiv-carousel--radius-none",
      md: "primitiv-carousel--radius-md",
    },
    placement: {
...
export const carouselSlide = cva("primitiv-carousel__slide", {
  variants: {
    ...
    surface: {
      none: "primitiv-carousel__slide--surface-none",
      subtle: "primitiv-carousel__slide--surface-subtle",
    },
  },
  defaultVariants: {
    radius: "md",
