import "../styles/primitiv/description-list/styles.css";
/*
 ...
 * scales both. The term is fixed SemiBold across every size and density
 ...
 */
export function DescriptionList({ size, className, ...props }: DescriptionListProps) {
  return <dl className={[descriptionList({ size }), className].filter(Boolean).join(" ")} {...props} />;
}
