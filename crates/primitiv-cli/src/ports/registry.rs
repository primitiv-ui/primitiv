...
const FILES: &[(&str, &str, &str)] = &[
    ...
    registry_file!("data-table", "styles.css"),
    registry_file!("data-table", "styles.scss"),
    registry_file!("data-table", "data-table.recipe.ts"),
    registry_file!("data-table", "data-table.tsx"),
    registry_file!("data-table", "contract.json"),
    ...
    registry_file!("combobox", "styles.css"),
    registry_file!("combobox", "styles.scss"),
    registry_file!("combobox", "combobox.recipe.ts"),
    registry_file!("combobox", "combobox.tsx"),
    registry_file!("combobox", "contract.json"),
