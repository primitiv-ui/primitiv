...
fn add_all_resolves_every_embedded_component() {
    ...
    Command::cargo_bin("primitiv")
        ...
        // collapsible + select + navigation-menu + avatar.
        .stdout(predicate::str::contains("Resolved 26 components to add:"))
        .stdout(predicate::str::contains("button"))
        ...
        .stdout(predicate::str::contains("popover"))
        .stdout(predicate::str::contains("dropdown"))
        ...
        .stdout(predicate::str::contains("collapsible"))
