...
/// Drift guard: the committed `registry/components/carousel/styles.scss` is
/// exactly the derived form of its canonical `styles.css` — the compound proof.
#[test]
fn the_committed_carousel_scss_is_the_derived_form_of_its_css() {
    let css = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../registry/components/carousel/styles.css"
    ));
    let scss = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../registry/components/carousel/styles.scss"
    ));
...
/// Drift guard: the committed `registry/components/accordion/styles.scss` is
/// exactly the derived form of its canonical `styles.css`.
#[test]
fn the_committed_accordion_scss_is_the_derived_form_of_its_css() {
    let css = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../registry/components/accordion/styles.css"
    ));
    let scss = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../registry/components/accordion/styles.scss"
    ));

    assert_eq!(emit_component_scss(css), scss);
}

/// Drift guard: the committed `registry/components/divider/styles.scss` is the
/// derived form of its CSS.
#[test]
fn the_committed_divider_scss_is_the_derived_form_of_its_css() {
    let css = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../registry/components/divider/styles.css"
    ));
    let scss = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../registry/components/divider/styles.scss"
    ));

    assert_eq!(emit_component_scss(css), scss);
}

/// Drift guard: the committed `registry/components/table/styles.scss` is the
/// derived form of its CSS.
#[test]
fn the_committed_table_scss_is_the_derived_form_of_its_css() {
    let css = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../registry/components/table/styles.css"
    ));
    let scss = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../registry/components/table/styles.scss"
    ));

    assert_eq!(emit_component_scss(css), scss);
}

/// Drift guard: the committed `registry/components/toggle-group/styles.scss` is
/// the derived form of its CSS.
#[test]
fn the_committed_toggle_group_scss_is_the_derived_form_of_its_css() {
    let css = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../registry/components/toggle-group/styles.css"
    ));
    let scss = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../registry/components/toggle-group/styles.scss"
    ));
...
/// Drift guard: the committed `registry/components/avatar/styles.scss` is the
/// derived form of its CSS.
#[test]
fn the_committed_avatar_scss_is_the_derived_form_of_its_css() {
    let css = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../registry/components/avatar/styles.css"
    ));
    let scss = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../registry/components/avatar/styles.scss"
    ));

    assert_eq!(emit_component_scss(css), scss);
}

/// Drift guard: the committed `registry/components/breadcrumb/styles.scss` is
/// the derived form of its CSS.
#[test]
fn the_committed_breadcrumb_scss_is_the_derived_form_of_its_css() {
    let css = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../registry/components/breadcrumb/styles.css"
    ));
    let scss = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../registry/components/breadcrumb/styles.scss"
    ));
