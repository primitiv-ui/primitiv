...
// overwrites this to "Checkbox" at load, so the value is never observable. The
// assignment stays because it declares `displayName` on `typeof CheckboxRoot`,
// which TCheckboxCompound extends.
